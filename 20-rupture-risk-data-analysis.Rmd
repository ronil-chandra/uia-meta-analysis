...
forest(pes.summary.glmm.all,
       ...
       smlab = " ",
       xlim=c(0,10),
       xlab = "Rupture per 100 aneurysms over mean study-level follow up: 51 months",
       pooled.events = TRUE,
       ) 
...
forest(pes.summary.glmm,
       ...
       smlab = " ",
       xlim=c(0,10),
       xlab = "Rupture per 100 aneurysms over mean study-level follow up: 43 months",
       pooled.events = TRUE,
       ) 
...
forest(pes.summary.glmm7,
       ...
       smlab = " ",
       xlim=c(0,10),
       xlab = "Rupture per 100 aneurysms over mean study-level follow up: 42 months",
       pooled.events = TRUE,
       ) 
...
forest(pes.summary.glmm3,
       ...
       smlab = " ",
       xlim=c(0,10),
       xlab = "Rupture per 100 aneurysms over mean study-level follow up: 47 months",
       pooled.events = TRUE,
       ) 
