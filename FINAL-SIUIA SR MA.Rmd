...
bubble(psah.metareg.result,
       xlim=c(0, 0.5),
       xlab = "Proportion of patients with exposure to prior aAH",
...
Notably, this may be attributable to the older mean age in the Japanese samples with mean age of 64.5 from Japan compared to 57.24years, p-value = 0.001
