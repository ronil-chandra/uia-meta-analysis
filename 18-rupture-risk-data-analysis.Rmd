...
Statitical heterogeneity is most commonly measured using Cochrane's Q statistic, tau-squared statistic or the Inconsistency measure I^2 statistic. 
...
3. I^2 statistic. I^2 represents the proportion of total heterogeniety that can be attributed to the actual between-study heterogeniety. I^2 thresholds within 25, 50, and 75% represent low, moderate, and high heterogeneity, respectively. 95% CIs can also be calculated for the I^2 statistic to demonstrate the uncertainty of the result. 
