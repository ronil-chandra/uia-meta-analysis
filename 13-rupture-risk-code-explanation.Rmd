...
```{r metaregression data setup for length of follow up - excluding Juvela}
...
```{r metaanalysis pf proporations for metareg - option 2 - excluding Juvela}
...
```{r metaregression exploration - option 2 - excluding Juvela}

fu.metareg.result.juvela <- metareg(fu.metareg.juvela, ~fu)
fu.metareg.result.juvela
```

```{r metaregression - option 2 - bubble plot - excluding Juvela}
...
```{r metaregression data setup for prior SAH at study level, excluding Juvela - data setup}
...
```{r metaregression data setup for prior SAH at study level, excluding Juvela - execution}
...
```{r metaregression - option 2 - bubble plot - , excluding Juvela psah}
