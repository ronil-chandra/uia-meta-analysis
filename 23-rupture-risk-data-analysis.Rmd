...
The research protocol was pre-specified and published on PROSPERO. When considering the research question, the FINER criteria have been proposed as encapsulating the issues that should be addressed when developing research questions. 

These state that questions should be Feasible, Interesting, Novel, Ethical, and Relevant (Cummings et al 2007).
...
Good Quality studies  1.8534 [1.5697; 2.1872] over 68 months 
All studies           1.2625 [0.9445; 1.6858] over 43 months. 
...
Visual inspection of the funnel plot reveals asymmetry, likely due to non-reporting bias, lsmall study effects and clincial and methodogical heterogeneity.   

### Small study effects 

Small study effects can be assessed with additional sensitivity analysis considering the random vs fixed effect model. In the setting of heterogeneity, the random effects estimate is biased towards the results of the smaller studies. We can investigatieif small study effects 
cause a clinically relevant change in the point estimate and CIs.
...
Since these estimates are similar, with little clinically relevant difference,s this sensitivity analysis shows that mall-study effects have little effect on the irupture risk estimate. 
### Limitations
