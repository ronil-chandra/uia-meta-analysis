...
The random effects meta-regression included participants from 29 studies with a mean study level proportion of exposure to prior subarachnoid haemorrhage of 12.2% (range 0 - 49.8%). The overall covariate distribution is not concerning with a total of 181 ruptures and 12 686 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant (F(1,27)=.21, P=.65), suggesting that the proportion of patients with prior aSAH included in the studies was not associated with the rupture proportion at the study level. There is moderate unexplained residual heterogeneity (I2 = 57.8%), which is higher than across all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to aggregation bias and confounding bias from other study level characteristics. 
...
bubble(size5mm.metareg.result, 
       ...
       ylab = "RLogit tranformed ruptureproportion",
       lty = 3,
       lwd = 2,
...
The random effects metaregression included participants from 26 studies with a mean study level proportion of 5mm aneurysms of 77% (range 254.7 - 100%). The overall covariate distribution is not concerning with a total of 173 ruptures and 11 381 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant (F(1,24)=.06, P=.81), suggesting that the proportion of patients with ≤5mm included in the study was not associated with the rupture proportion at the study level. There is moderate unexplained residual heterogeneity (I2 = 54.2%), which similar to all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to aggregation bias and confounding bias from other study level characteristic.
...
The random effects metaregression included participants from 201 studies with a mean study level proportion of aneurysm multiplicity of 30.1% (range 0 - 54.9%). The overall covariate distribution is not concerning with a total of 168 ruptures and 11 557 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant (F(1,19)=0.83, P= 0.37), suggesting that the proportion of patients with multiple aneurysms included in the study was not associated with the rupture proportion at the study level. However, there is moderate unexplained residual heterogeneity (I2 = 50.8%), which similar to all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to aggregation bias and confounding bias from other study level characteristic.
...
T
This random effect meta-regression analysis included participants from 30 studies with a mean study level patient age of 59.0 +/- 6.8 years (range 47.9-73.3 years). There was a total of 190 ruptures and 13 359 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant (F(1,28)=1.35, P=0.25) suggesting that increasing study-level age was not associated with the rupture proportion at the study level. There is moderate unexplained residual heterogeneity (I2 = 39.1%), indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. However, this analysis is susceptible to aggregate data bias and confounding bias from other study level characteristics.
