...
maindata <- read_csv("data/clean_data_SR_MA_final_excChienincVill.csv")
...
Summary estimate is 1.0695 [0.6819; 1.6738] over study level mean of 4.265316	 years. 
...
forest(pes.summary.glmm.all,
       ...
       pooled.events = TRUE,
       text.addline1 = "Mean study-level follow up: 4.2 years",
       JAMA.pval = TRUE,
       ) 
...
I^2 = 85.9%, which is high, which means that the between study variation due to clinical and methodological variation between studies is high, and greater than that expected by random chance variation within studies. 
...
The pooled rupture risk without Juvela et al is 1.0459 [0.6530; 1.6714]

Although the pooled rupture risk is still between 1-2%, the precision of the estimate has improved with narrower confidence intervals, and the I2 has reduced from 85.9 to 56.7%, which makes the result more robust and more generalisable. 
...
Summary estimate is 1.0982 [0.7930; 1.5192] with I2 of 56.7% over study level mean of 3.7 years. 
...
Interpretation - not updated: 

The random effects metaregression included participants from 29 studies with a mean study level proportion of exposure to prior subarachnoid haemorrhage of 12.2% (range 0 - 49.8%). There were a total of 181 ruptures and 12 686 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant (F[1,25)=.2097,P=.6506), suggesting that the proportion of patients with prior SAH included in the study was not associated with the risk of rupture at the study level. However, there is moderate unexplained residual heterogeneity (I2 = 57.8%), which is higher than across all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to confounding bias from other study level characteristics, and is not generalisable to an individual patient, since there is aggregation bias due to study-level data being used for analysis. 
...
The random effects metaregression included participants from 26 studies with a mean study level proportion of 5mm aneurysms of 77% (range 25 - 100%). There were a total of 173 ruptures and 11 381 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant F(df1 = 1, df2 = 24) = 0.0623, p-val = 0.8050, suggesting that the proportion of patients with 5mm and less aneurysms included in the study was not associated with the risk of rupture at the study level. However, there is moderate unexplained residual heterogeneity (I2 = 54.2%), which similar to all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to confounding bias from other study level characteristics, and is not generalisable to an individual patient, since there is aggregation bias due to study-level data being used for analysis.
...
The random effects metaregression included participants from 20 studies with a mean study level proportion of aneurysm multiplicity of 30.7% (range 0 - 55%). There were a total of 165 ruptures and 11 634 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant F(df1 = 1, df2 = 18) = 0.7530, p-val = 0.3970, suggesting that the proportion of patients with multiple aneurysms included in the study was not associated with the risk of rupture at the study level. However, there is moderate unexplained residual heterogeneity (I2 = 54.6%), which similar to all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to confounding bias from other study level characteristics, and is not generalisable to an individual patient, since there is aggregation bias due to study-level data being used for analysis.
...
The random effects metaregression included participants from 29 studies with a mean study level patient age of 59.0 +/- 6.9 years (range 47.9 - 73.3 years). There were a total of 187 ruptures and 13 166 aneurysms in studies included in this metaregression analysis. The metaregression result was not significant F(df1 = 1, df2 = 27) = 1.1387, p-val = 0.2954, suggesting that mean age was associated with the risk of rupture at the study level. There was no unexplained residual heterogeneity (I2 = 43.6%) indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. However, this random effects metaregression analysis is susceptible to confounding bias from other study level characteristics, and is not generalisable to an individual patient, since there is aggregation bias due to study-level data being used for analysis.
...
The test for subgroup differences (random effects model) indicates that there is no statistically significant subgroup effect, suggesting that age > 65 years was not associated with a higher the rupture risk compared to mean study age <65 years across the included trials.
...
The test for subgroup differences (random effects model) indicates that there is a statistically significant subgroup effect (p = 0.0003), suggesting that a Japanese source population was associated with a higher the rupture risk across the included trials. 

This covariate also explains some of the heterogeniety, with only minimal heterogeneity remaining  I^2 = 0.0% [0.0%; 22.9%. The overall covariate distribution is not concerning with the total number of studies and participants with aneurysms in each sub-group.

This result is interesting from a clinical perspective, since the sub-group rupture risk in the Japanese population was higher 1.9494 [1.5590; 2.4353] over a shorter follow up period of 3.2 years, compared to the sub-group rupture risk in non-Japanese of 0.9196 [0.6205; 1.3611]  over a mean study follow up period of 3.9 years. 
...
The random effects metaregression included participants from 27 studies with a mean study level follow up time of 3.7 years (range 1.4 - 8.3 years). There were a total of 182 ruptures and 12 945 aneurysms in studies included in this metaregression analysis. The metaregression result was not significantF(df1 = 1, df2 = 25) = 0.0409, p-val = 0.8414, suggesting that the proportion of mean study level follow up time was not associated with the risk of rupture at the study level. However, there is moderate unexplained residual heterogeneity (I2 = 55.8%), which similar to all included studies, indicating that this meta-regression analysis was not informative in identifying sources of heterogeneity in the meta-analysis result. In addition, this random effects metaregression analysis is susceptible to confounding bias from other study level characteristics, and is not generalisable to an individual patient, since there is aggregation bias due to study-level data being used for analysis.
...
Main result summary estimate is 1.0982 [0.7930; 1.5192] with I2 of 56.7% over study level mean of 3.7 years.

Sensitivity analysis performed with aneurysms measuring 7 mm and less have a pooled rupture risk estimate of is 0.8976 [0.6171; 1.3041] with I2 of 52.3% over study level mean of 3.6 years.
...
Sensitivity analysis performed with aneurysms measuring 5 mm and less have a pooled rupture risk estimate of 1.0262 [0.8140; 1.2930] over 3.6 years, with I^2 = 0%. This sensitivity analysis does not alter the overall impact from a clinical perspective, since the pooled rupture risk remains within 1-2%.
...
Sensitivity analysis performed with aneurysms measuring 3 mm and less have a pooled rupture risk estimate of 0.7605 [0.3807; 1.5131] over 3.8 years, with I^2 = 0%. This sensitivty analysis is limited due to lack of rupture events and SUIAs. Nonetheless, the sensitivity analysis does not alter the overall impact from a clinical perspective, since the pooled rupture risk remains within 1-2%.
...
The pooled rupture risk with Juvela et al is 1.0459 [0.6530; 1.6714]

The impact of including Juvela et al is to reduce the precision of the summary estimate with wider confidence intervals. The inconsistency in the result increases from I2 of 56.7% to 85.9% making the result less generalisable. Regardless from a clinical perspective, this sensitivity analysis does not alter the overall impact, since the pooled rupture risk remains within 1-2%.  
...
Good quality studies 1.7477 [1.4926; 2.0455] with I2 of 0% over 3.9 years. 
...
Fixed effect model   1.44 [1.25; 1.66]
Random effects model 1.1 [0.79; 1.52]
