...
To reduce the risk of false positives, and to ensure that there are adequate studies to consider meta-regression, only 3 potential effect modifiers are chosen, based on clinical hypotheses, supported by previously published data, and that are unlikely to be co-linear. In our case, potential effect modifiers to consider include:

1. Size of the unruptured aneurysm
2. Exposure to prior subarachnoid haemorrhage
...
Sensitivity analysis differs from subgroup analysis in that there is no assessment of the treatment effect in the removed studies, nor is there formal statistical assessment across the included and excluded studies. Instead, there is an informal comparison by recalculating the pooled effect size. Rather than produce multiple new forest plots, a summary table can be produced that includes the results of the sensitivity analysis. 
