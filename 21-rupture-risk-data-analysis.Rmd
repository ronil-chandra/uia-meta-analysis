...
Similarly, if sensitivity analyses show that the overall result and conclusions are affected, the results should be interpreted with caution, and could instead be considered hypothesis generating for additional research. 
