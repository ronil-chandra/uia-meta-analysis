...
forest(pes.summary.glmm3,
       ...
       xlab = "Rupture per 100 aneurysms",
       pooled.events = TRUE,
       text.addline1 = "Mean study-level follow up: 47 months",
       JAMA.pval = TRUE,
       ) 
...
1. Pre-specified 
2. Post hoc sensitivity analysis to consider the decision to exclude outlier studies. 1
...
In this study, we have handled missing 
...
T1. Post hoc sensitivity analysis to consider whether the pooled rupture risk varies with utilisation of a fixed or random effects meta-analysis method. 
...
hese plots shows the contribution of each study to the overall Q-test statistic for heterogeneity on the horizontal axis versus the influence of each study (defined as the standardized squared difference between the overall estimate based on a fixed-effects model with and without the study included in the model) on the vertical axis. *Baujat 2002* 
