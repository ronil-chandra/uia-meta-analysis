...
1. Pre-specified 
2. Post hoc sensitivity analysis to consider the decision to exclude outlier studies. 
...
### Sensitivity analysis - aneurysm size categories
...
#### Sensitivity analysis based on aneurysm size 5 mm and less 
