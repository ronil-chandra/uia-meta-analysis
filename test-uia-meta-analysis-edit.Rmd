...
# Meta-analysis of proportions using DL method and CP method for CIs
...
# Display meta-analysis as a simple forest using DL and CP
...
# Meta-analysis of proportions using DL method Wilson method for CIs
...
```{r forest for publication with DL and Wilson method for CIs, fig.width = 10}

pes.summary=metaprop(rupt, total_10, data=dat, sm="PFT", method.tau = "DL", method.ci = "WS", pscale = 100) 
